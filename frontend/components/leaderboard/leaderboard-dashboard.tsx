...
const LeaderboardRow = ({
  ...
  return (
    <tr className={[
      "transition-colors",
      row.user_id === user?.id ? "bg-zinc-200 dark:bg-zinc-600 hover:bg-zinc-200/80 dark:hover:bg-zinc-600 font-bold text-lg" : "hover:bg-zinc-50/70 dark:hover:bg-zinc-800/40 font-medium",
    ].join(" ")}>
      <td className={[
