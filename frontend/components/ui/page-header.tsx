...
export const PageHeader = ({
  ...
  return (
    <section className="flex flex-col gap-5 border-b border-zinc-200 bg-white px-4 py-8 dark:border-zinc-800 dark:bg-zinc-900 sm:px-6 lg:px-8">
      <div className="mx-auto flex w-full max-w-7xl flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
        <div className="min-w-0">
          ...
          <h1 className="mt-2 text-3xl font-semibold tracking-normal text-zinc-950 dark:text-zinc-50 sm:text-4xl">
            {title}
          </h1>
          {subtitle ? (
